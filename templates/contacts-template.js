...
async function selectMoreContactInformationTemplate(contact, initial) {
    return `<section class="contact-info-container" id="contact-${contact.key}">
                    ...
                    <div class="procressing-mobile-menu-container">
                        <div class="procressing-mobile-menu">
                            <div class="procressing-area-button-mobile-position">
                                <button class="procressing-area-edit-button-mobile" onclick="editContactOverlay('${contact.key}'); toggleButtonColor(this), toggleBackgroundProcressButton()">
...
return` <div class="new-Contect-Container">
            ...
            <div class="add-input-contact-container">
                <div class="close-btn">
                ...
                <form onsubmit="addUserToContactList(event, this);" novalidate>
                    <div class="input-container">
                        <div class="input-area">
                            <input type="text" onkeyup="handleContactNameUnvalidInputs()" placeholder="Name" id="name" required>
                            <img src="../assets/img/person-grey.png" alt="">
                        </div>
                        <p id="error-message-name" class="error-message">This field is required!</p>
                        <div class="input-container">
                            <div class="input-area">
                                <input type="email" onkeyup="handleContactEmailUnvalidInputs()" placeholder="Email" id="email" required>
                        ...
                        <div class="input-container">
                            <div class="input-area">
                                <input type="tel" onkeyup="handleContactPhoneUnvalidInputs()" name="phone" placeholder="Phone" id="phone" required>
                        ...
                        <div class="contact-button-container">
                            ...
                            <button class="create-btn" type="submit" onclick="addUserToContactList(event, this.closest('form'))">Create contact <img src="../assets/icons/check.svg" alt=""></button>
                        </div>
                    </div>
                </form>
            </div>
...
function getEditContactTemplate(key) {
    return `<div class="edit-Contect-Container">
                <div class="information-content-container">
                    <img src="../assets/img/join-logo-weiß.png" alt="">
                    <h1>Edit contact</h1>
                    <hr>
                </div>
                <div class="edit-add-input-contact-container">
                    <div class="close-btn">
